...
public class hapusdiagnosa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Data berhasil dihapus/Data tidak ditemukan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hapusdiagnosa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hapusdiagnosa().setVisible(true);
            }
        });
    }
